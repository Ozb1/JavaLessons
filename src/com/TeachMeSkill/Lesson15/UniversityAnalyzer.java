...
public class UniversityAnalyzer {
    ...
    public Integer getMinStudentAgeInYears(Stream<Student> students) {
        ...
        return students.mapToInt(dateOfBith -> Period.between(dateOfBith.getBirthday(), currentlyDate)
                .getYears()).min().orElseThrow();
    }
    ...
    public List<Student> sortStudentsByCountOfMarks(Stream<Student> students) {
        //TODO
        return students.sorted(Comparator.comparing((Student student) -> student.getSubjectMarks()
                                .size()).reversed()
